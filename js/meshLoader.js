    ...
    */
    ...
    for( var i=0; i<lines.length; i++ ){
      ...
      // if this is a texture
		...
		var tokens = lines[i].slice(3).split(" ");
		texCoords.push(tokens[0]);
		texCoords.push(tokens[1]);
	  }
      // if this is a face
        ...
        for(var j=1; j <= line.length-2; j++){
			...
			var ti1 = line[0].split('/')[1] - 1;
			var ti2 = line[j].split('/')[1] - 1;
			var ti3 = line[j+1].split('/')[1] - 1;
			packed.texIndices.push(ti1, ti2, ti3);
		}
	  }
	}
	this.vertices = verts;
	this.indices = packed.indices;
	this.texIndices = packed.texIndices;
